    ...
    >
      ...
      <section>
        ...
        <div className="content">
          <ul>
            <li>
              Whether travelling solo, with family or on a business ,leisure or
              study trips, a peaceful journey is all we need during a trip. And
              for us at Tata AIG, your journey is as important as your
              destination!
            </li>
            <li>
              Be it home turf or international locations, the Tata AIG travel
              insurance plans will cover your back at every step of the journey,
              taking care of you and your family against any adverse situations,
              be it medical or any trip inconvenience.
            </li>
            <li>
              Our 24X7 worldwide assistance network are always on the job to
              support , guide & make your journeys a memorable one.
              <br />
              So, travel the world and make memories with Tata AIG Travel Plans!{" "}
            </li>
          </ul>
        </div>
      ...
      <section className="advantage">
        ...
        <section>
          ...
          <p>
            We are from House of Tata and legacy of trust and
            customer-centricity precedes us
          </p>
        </section>
        <section>
          <div>
        ...
        <section>
          ...
          <p>
            We have a wide array of add-on covers to accentuate your choices
          </p>
        </section>
        <section>
          <div>
          ...
          <p>
            We are widely connected to a network of 6500+ cashless garages in
            India
          </p>
        </section>
      </section>
      <section className="mainCntr">
        ...
        <button on="tap:" className="btnSecondary renew w-100">
          Download Policy Wordings
        </button>
        <h2 className="heading">
          Is Your Next Destination Covered By TATA AIG Travel Insurance !
        </h2>
        <form
